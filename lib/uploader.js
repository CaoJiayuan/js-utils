...
function fileUpload(el, url, config) {
    config = config || {};
 ...
 * @param chunkSize
 */
function chunkUpload(file, name, url, success, error, progress, chunkSize) {
...
function uploadChunk(name, url, {blob, start, end, total, chunk_size, filename, file_id, index, mime_type}, count, onSuccess, onError) {
